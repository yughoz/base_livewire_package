...
@include('adminlte::livewire.helpers.modals',['module_code' => 'settings','body' => 'settings.create','modal_id' => 'createModal','action' => 'store()'])
@include('adminlte::livewire.helpers.modals',['module_code' => 'settings','body' => 'settings.update','modal_id' => 'updateModal','action' => 'update()'])
