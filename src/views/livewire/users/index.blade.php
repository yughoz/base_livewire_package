...
@include('adminlte::livewire.helpers.modals',['module_code' => 'users','body' => 'users.create','modal_id' => 'createModal','action' => 'store()'])
@include('adminlte::livewire.helpers.modals',['module_code' => 'users','body' => 'users.update','modal_id' => 'updateModal','action' => 'update()'])
@include('adminlte::livewire.helpers.modals',['module_code' => 'company','body' => 'company.selected','modal_id' => 'company_modal','action' => 'selectedAction()'])
@include('adminlte::livewire.helpers.modals',['module_code' => 'role','body' => 'roles.selected','modal_id' => 'role_modal','action' => 'selectedAction()'])
